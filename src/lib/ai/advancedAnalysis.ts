...
export function generatePersonalizedGreeting(analysis: any): string {
  ...
  if (tradingStyle === 'Expert') {
    return `🚀 **Hey there, Funded Trader!** Welcome back to your winning journey!\n\nI'm Tradia AI, your specialist Forex coach, and I can see you're operating at an elite level. Your ${winRate.toFixed(1)}% win rate and $${totalPnL.toFixed(2)} in profits speak volumes about your skill and dedication to professional capital management.\n\n**What I notice about you:** You're consistently using ${topStrategy} strategies and maintaining a ${topEmotion} mindset. ${journalInsight ? `Your journal shows: "${journalInsight}"` : ''}\n\nLet's take your already impressive performance to the next level and scale your funded journey!`;
  } else if (tradingStyle === 'Advanced') {
    return `💪 **Hey there, Evaluated Trader!** Great to see you back at the charts!\n\nI'm Tradia AI, your specialist Forex coach. Your ${winRate.toFixed(1)}% win rate shows you're building solid habits and protecting your drawdown effectively. With ${totalTrades} trades analyzed, you're well on your way to securing higher funding.\n\n**Your trading personality:** I can see you're developing strong ${topStrategy} skills and staying ${topEmotion} during trade execution. ${journalInsight ? `From your notes: "${journalInsight}"` : ''}\n\nLet's refine your edge and push those numbers even higher!`;
  } else if (tradingStyle === 'Intermediate') {
    return `🌟 **Hey there, Growing Forex Trader!** Welcome back to your funded journey!\n\nI'm Tradia AI, your specialist trading coach. I can see you're putting in the work with ${totalTrades} trades and developing your Forex edge. Your ${winRate.toFixed(1)}% win rate is a strong foundation for future evaluations.\n\n**What I'm learning about you:** You're experimenting with ${topStrategy} approaches and experiencing ${topEmotion} emotions. ${journalInsight ? `Your reflections show: "${journalInsight}"` : ''}\n\nLet's focus on session consistency and risk-to-reward together!`;
  } else {
    return `🎯 **Hey there, Aspiring Prop Trader!** Welcome to your funded career!\n\nI'm Tradia AI, your specialist coach and mentor. I see you're starting your journal with ${totalTrades} trades — that's the most important step in professionalizing your Forex career.\n\n**Your fresh perspective:** I notice you're trying ${topStrategy} strategies and maintaining a ${topEmotion} focus. ${journalInsight ? `Your notes reveal: "${journalInsight}"` : ''}\n\nLet's build your drawdown management skills together and secure that first funded account!`;
  }
}
