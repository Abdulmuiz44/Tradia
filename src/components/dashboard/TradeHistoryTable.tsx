...
export default function TradeHistoryTable({ trades: overrideTrades }: TradeHistoryTableProps = {}) {
    ...
    const headerCell = (
        ...
        return (
            <th
                key={label}
                className={`px-3 py-2 font-medium border-b border-gray-300 dark:border-gray-600 ${sortable ? "cursor-pointer select-none" : ""
                    }`}
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2 text-sm text-zinc-300">
                            <div className="hidden md:flex items-center gap-3">
                                ...
                                <div className="px-3 py-2 rounded bg-white dark:bg-[#0f1319] border border-gray-200 dark:border-gray-700">
                                    <div className="text-xs text-gray-600 dark:text-gray-300">Avg RR</div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        title="Export"
                    >
                        <DownloadCloud size={18} className="text-gray-700 dark:text-gray-300" />
                    </button>
...
*/}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-2 mb-4 text-sm">
                    {(["symbol", "outcome"] as const).map((f) => (
                        <input
                            key={f}
                            type="text"
                            className="p-2 rounded bg-white dark:bg-[#0f1319] border border-gray-200 dark:border-gray-700 text-black dark:text-white w-full"
                            placeholder={f}
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="px-3 py-2 bg-white dark:bg-[#0f1319] rounded hover:bg-gray-100 dark:hover:bg-zinc-700 text-black dark:text-white border border-gray-200 dark:border-gray-700 text-sm"
                        >
                            Reset Filters
                        </button>
                    </div>
            ...
            <div className="space-y-3">
                ...
                {/* Table for sm+ */}
                <div className="hidden sm:block overflow-x-auto bg-white dark:bg-[#0f1319] rounded-xl shadow-lg max-h-96 w-full border border-gray-200 dark:border-gray-700">
                    {
                        <table className="min-w-full text-sm text-left table-fixed text-black dark:text-white">
                            <thead className="bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-200 sticky top-0">
                                <tr>
                                    {headerCell("Symbol", true, "symbol")}
                                    {headerCell("Direction", true, "direction")}
                                    <th className="px-3 py-2 font-medium border-b border-gray-300 dark:border-gray-600">Order Type</th>
                                    {headerCell("Open Time", true, "openTime")}
                                    {headerCell("Close Time", true, "closeTime")}
                                    <th className="px-3 py-2 font-medium border-b border-gray-300 dark:border-gray-600">Session</th>
                                    ...
                                    <th className="px-3 py-2 font-medium border-b border-gray-300 dark:border-gray-600">Emotion</th>
                                    <th className="px-3 py-2 font-medium border-b border-gray-300 dark:border-gray-600">Notes</th>
                                    <th className="px-3 py-2 font-medium border-b border-gray-300 dark:border-gray-600">Before</th>
                                    <th className="px-3 py-2 font-medium border-b border-gray-300 dark:border-gray-600">After</th>
                                    <th className="px-3 py-2 font-medium border-b border-gray-300 dark:border-gray-600">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                {pageItems.length === 0 ? (
                                    ...
                                    pageItems.map((t, idx) => {
                                        ...
                                        return (
                                            <tr key={idKey} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="mt-3 flex flex-col sm:flex-row items-center justify-between text-sm text-gray-700 dark:text-zinc-300 gap-3">
                <div>
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        disabled={page <= 1}
                        className="px-3 py-1 rounded bg-gray-200 dark:bg-zinc-700 text-black dark:text-white disabled:opacity-50 border border-gray-300 dark:border-gray-600"
                    >
                        Prev
                    </button>
