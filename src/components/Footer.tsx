...
export default function Footer() {
  ...
  return (
    <footer className="py-10 mt-20 border-t border-gray-200/70 dark:border-white/10 bg-white/70 dark:bg-[#0f1319]/70 supports-[backdrop-filter]:backdrop-blur">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400">
            ...
            <select
              ...
              className="px-2 py-1 rounded-md bg-white/70 dark:bg-[#0f1319] border border-gray-300 dark:border-white/10 text-gray-700 dark:text-gray-200"
              value={currentTheme}
