...
export default function Home() {
  ...
  const navSignup = () => router.push('/app/signup');
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 px-6">
            ...
            <div>
              <div className="bg-gradient-to-br from-indigo-600 to-pink-500 text-white p-6 rounded-2xl shadow-xl">
                ...
                <div className="mt-6">
                  <Link href="/app/insights" className="inline-flex items-center gap-2 rounded-full bg-white/20 px-4 py-2 font-semibold">See more insights <AiOutlineArrowRight /></Link>
                </div>
              </div>
            </div>
          </div>
