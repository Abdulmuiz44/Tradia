...
export const TradePickerPanel: React.FC<TradePickerPanelProps> = ({
  ...
  const filteredTrades = trades
    ...
    .sort((a, b) => {
      switch (sortBy) {
        case 'date-desc':
          return new Date(b.entry_time || b.openTime || 0).getTime() - new Date(a.entry_time || a.openTime || 0).getTime();
        case 'date-asc':
          return new Date(a.entry_time || a.openTime || 0).getTime() - new Date(b.entry_time || b.openTime || 0).getTime();
        case 'pnl-desc':
